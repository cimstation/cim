...
_l2:;
   ...
   act_rec.g374_aa_get_point_type = act_rec.str;
...
_end_label:;
   ...
   return act_rec.g374_aa_get_point_type;
}
 ...
 integer pnt_num;
{
   ...
   struct ff511556_aa_build_point_na {
      ...
      s_t_r tmp_6;
      s_t_r tmp_5;
      s_t_r g375_aa_build_point_name;
   } act_rec;
...
_l1:;
   ...
   act_rec.g375_aa_build_point_name = act_rec.str;
...
_end_label:;
   ...
   return act_rec.g375_aa_build_point_name;
}
...
_l2:;
   ...
   act_rec._s_826 = (lispob)(act_rec.tmp_0);
   goto _l1;
...
_l5:;
   ...
   act_rec.g376_aa_fixup_filename = f731487_lowercase(
      act_rec.res
   );
...
_end_label:;
   ...
   return act_rec.g376_aa_fixup_filename;
}
...
_l1:;
   ...
   act_rec.g377_is_abb_robot = act_rec.ret;
...
_end_label:;
   ...
   return act_rec.g377_is_abb_robot;
}
 ...
 lispob lor;
{
   ...
   struct ff720801_aa_abb_ea {
      ...
      padding_type pad__0;
      real tmp_6;
      s_t_r s_t_r_16;   /* the string "%.4f" */
      s_t_r tmp_5;
      s_t_r tmp_3;
      lispob nil_19;   /* the global variable nil */
      s_t_r s_t_r_20;   /* the string "9E9" */
      s_t_r s_t_r_21;   /* the string "," */
      integer tmp_2;
      idob false_23;   /* the global variable false */
      integer integer_24;   /* 6 */
      lispob tmp_4;
      s_t_r s_t_r_26;   /* the string ",9E9" */
      s_t_r s_t_r_27;   /* the string "]" */
      s_t_r g378_aa_abb_ea;
   } act_rec;
...
_l1:;
   ...
   act_rec.tmp_0 = (boole)boolean2obj(act_rec.i > act_rec._s_829);
   if (!((boole)(act_rec.tmp_0))) goto _l2;
   goto _l3;
...
_l6:;
   ...
   act_rec.tmp_2 = (integer)act_rec.i + act_rec._s_828;
   act_rec.i = (integer)(act_rec.tmp_2);
   goto _l1;

_l3:;

   if (!(((boole)(act_rec.false_23->id_value)))) goto _l7;
...
_l7:;
   ...
   act_rec.g378_aa_abb_ea = f686094_times(
      act_rec.str,
      act_rec.s_t_r_27
   );
...
_end_label:;
   ...
   return act_rec.g378_aa_abb_ea;
}


/* F401200_AA_ABB_QUADRANT */

integer f401200_aa_abb_quadrant(pad__1, j_orig)
 integer pad__1;
 real j_orig;
{
   ...
   struct ff401200_aa_abb_quadrant {
      ...
      integer quad_num;
      padding_type pad__2;
      real real_13;   /* 0.000000000000000e+000 */
      boole tmp_5;
      integer ret;
      lispob nil_16;   /* the global variable nil */
      idob geom_epsilon_17;   /* the global variable geom_epsilon */
      integer integer_18;   /* 1 */
      integer tmp_6;
      integer g379_aa_abb_quadrant;
   } act_rec;
...
#ifdef COMP_TRACE
   if (act_rec._num_of_ && ncode_bit_fcn2(pad__1, j_orig))
...
_l1:;
   ...
   act_rec.tmp_5 = (boole)boolean2obj(act_rec.tmp_1 < (*((real *)(((charp)(act_rec.geom_epsilon_17->id_value)) + sizeof(real)))));
...
_l2:;
   ...
   act_rec.g379_aa_abb_quadrant = act_rec.ret;
...
_end_label:;
   ...
   return act_rec.g379_aa_abb_quadrant;
}
 ...
 shapep rob;
{
   ...
   struct ff163095_aa_calc_cfx {
      ...
      shapep rob;
      padding_type pad__3;
      real real_5;   /* 9.000000000000000e+001 */
      real tmp_3;
      boole elbow_down;
      padding_type pad__4;
      real real_9;   /* 0.000000000000000e+000 */
      boole j5_pos;
      idob true_11;   /* the global variable true */
      boole in_front;
      shapep flg_shp;
      id id_14;   /* LINK1 */
      shapep link1_shp;
      boole tmp_0;
      lispob tmp_5;
      idob null_shape_18;   /* the global variable null_shape */
      lispob tmp_7;
      boole tmp_6;
      padding_type pad__5;
      struct frame tmp_10;
      ...
      lispob nil_26;   /* the global variable nil */
      integer integer_27;   /* 0 */
      integer cfx_val;
      integer integer_29;   /* 4 */
      integer tmp_14;
      integer integer_31;   /* 2 */
      integer integer_32;   /* 1 */
      integer g380_aa_calc_cfx;
   } act_rec;
   ...
   act_rec.in_front = ((boole)(act_rec.true_11->id_value));
   ...
   act_rec.tmp_7 = (lispob)((shapep)(act_rec.null_shape_18->id_value));
   act_rec.tmp_6 = eq(
      act_rec.tmp_5,
      act_rec.tmp_7
   );
   ...
   act_rec.tmp_5 = (lispob)((shapep)(act_rec.null_shape_18->id_value));
   act_rec.tmp_6 = eq(
      act_rec.tmp_7,
      act_rec.tmp_5
   );
...
_l5:;
   ...
   act_rec.g380_aa_calc_cfx = act_rec.cfx_val;
...
_end_label:;
   ...
   return act_rec.g380_aa_calc_cfx;
}
...
_l4:;
   ...
   act_rec.g381_aa_abb_config = act_rec.str;
...
_end_label:;
   ...
   return act_rec.g381_aa_abb_config;
}
...
_l2:;
   ...
   act_rec.g382_aa_get_tool_pose = f775741_abb_pose(
      &(act_rec.tmp_6)
   );
...
_end_label:;
   ...
   return act_rec.g382_aa_get_tool_pose;
}
 ...
 integer index;
{
   ...
   struct ff664284_aa_format_robtarg {
      ...
      s_t_r str;
      s_t_r g383_aa_format_robtarget;
   } act_rec;
...
_l1:;
   ...
   act_rec.g383_aa_format_robtarget = act_rec.str;
...
_end_label:;
   ...
   return act_rec.g383_aa_format_robtarget;
}
 ...
 integer index;
{
   ...
   struct ff262427_aa_format_robtarg {
      ...
      integer integer_6;   /* 1 */
      integer proc_num;
      s_t_r g384_aa_format_robtarget;
   } act_rec;
   ...
   act_rec.proc_num =    -(1);
   act_rec.g384_aa_format_robtarget = f664284_aa_format_robtarg(
      act_rec.jjj,
      act_rec.ref_shape,
      act_rec.rob,
      act_rec.proc_num,
...
_end_label:;
   ...
   return act_rec.g384_aa_format_robtarget;
}
 ...
 integer index;
{
   ...
   struct ff729453_aa_format_robtarg {
      ...
      struct frame tmp_8;
      struct frame fr;
      real real_17;   /* 5.000000000000000e+001 */
      integer integer_18;   /* 0 */
      lispob lor;
      s_t_r s_t_r_20;   /* the string "    " */
      s_t_r tmp_18;
      ...
      s_t_r tmp_10;
      s_t_r tmp_3;
      s_t_r s_t_r_37;   /* the string "];" */
      s_t_r g385_aa_format_robtarget;
   } act_rec;
...
_l2:;
   ...
   act_rec.g385_aa_format_robtarget = act_rec.str;
...
_end_label:;
   ...
   return act_rec.g385_aa_format_robtarget;
}
 ...
 integer index;
{
   ...
   struct ff774156_aa_format_robtarg {
      ...
      integer integer_6;   /* 1 */
      integer proc_num;
      s_t_r g386_aa_format_robtarget;
   } act_rec;
   ...
   act_rec.proc_num =    -(1);
   act_rec.g386_aa_format_robtarget = f729453_aa_format_robtarg(
      act_rec.via_shp,
      act_rec.ref_shape,
      act_rec.rob,
      act_rec.proc_num,
...
_end_label:;
   ...
   return act_rec.g386_aa_format_robtarget;
}
 ...
 integer index;
{
   ...
   struct ff68741_aa_format_jointtar {
      ...
      s_t_r s_t_r_32;   /* the string "];" */
      s_t_r str;
      s_t_r g387_aa_format_jointtarget;
   } act_rec;
   ...
   act_rec.g387_aa_format_jointtarget = act_rec.str;
...
_end_label:;
   ...
   return act_rec.g387_aa_format_jointtarget;
}
 ...
 integer index;
{
   ...
   struct ff262076_aa_format_jointta {
      ...
      integer integer_4;   /* 1 */
      integer proc_num;
      s_t_r g388_aa_format_jointtarget;
   } act_rec;
   ...
   act_rec.proc_num =    -(1);
   act_rec.g388_aa_format_jointtarget = f68741_aa_format_jointtar(
      act_rec.b,
      act_rec.proc_num,
      index
   );
...
_end_label:;
   ...
   return act_rec.g388_aa_format_jointtarget;
}
 ...
 shapep ref_shape;
{
   ...
   act_rec._s_832 = act_rec.tmp_3 - 1;

_l1:;

   act_rec.tmp_0 = (boole)boolean2obj(act_rec.k > act_rec._s_832);
   if (!((boole)(act_rec.tmp_0))) goto _l2;
   goto _l3;
...
_l2:;
   ...
   act_rec.tmp_3 = (integer)act_rec.k + act_rec._s_831;
 ...
 shapep rob;
{
   ...
   struct ff389475_aa_write_abb_join {
      ...
      struct jv b;
      s_t_r str;
      idob write_tf_save_out_val_18;   /* the global variable write_tf_save_out_val */
      s_t_r s_t_r_19;   /* the string "    ! " */
      lispob nil_20;   /* the global variable nil */
   } act_rec;
   ...
   act_rec._s_835 = act_rec.tmp_4 - 1;

_l1:;

   act_rec.tmp_1 = boolean2obj(act_rec.k > act_rec._s_835);
...
_l2:;
   ...
   SET_OB_FCALL(act_rec.write_tf_save_out_val_18, id_value, out_val(), lispob);
   f929848_switch_output_to(
      act_rec.txt
   );
   f894339_tprint(
   ...
   terpri();
   switch_out(
      ((lispob)(act_rec.write_tf_save_out_val_18->id_value))
   );
   act_rec.tmp_4 = (integer)act_rec.k + act_rec._s_834;
...
_end_label:;
   ...
   return act_rec.nil_20;
}


/* F832026_AA_GET_BLEND_CODE */

integer f832026_aa_get_blend_code(pad__10, blend_dist)
 integer pad__10;
 real blend_dist;
{
   ...
   struct ff832026_aa_get_blend_code {
      ...
      padding_type pad__11;
      real tmp_2;
      real real_9;   /* 0.000000000000000e+000 */
      boole tmp_5;
      lispob nil_11;   /* the global variable nil */
      real real_12;   /* 5.000000000000000e-001 */
      integer integer_13;   /* 0 */
      integer integer_14;   /* 3 */
      integer integer_15;   /* 200 */
      padding_type pad__12;
      real tmp_1;
      integer integer_18;   /* 20 */
      padding_type pad__13;
      real real_20;   /* 5.000000000000000e+000 */
      real step_size;
      integer integer_22;   /* 60 */
      padding_type pad__14;
      real real_24;   /* 1.000000000000000e+001 */
      integer integer_25;   /* 100 */
      padding_type pad__15;
      real real_27;   /* 2.000000000000000e+001 */
      real real_28;   /* 5.000000000000000e+001 */
      integer tmp_6;
      integer tmp_7;
      integer g389_aa_get_blend_code;
   } act_rec;
...
#ifdef COMP_TRACE
   if (act_rec._num_of_ && ncode_bit_fcn2(pad__10, blend_dist))
      return ncode_integer_answer;
#endif
...
_l2:;
   ...
   act_rec.g389_aa_get_blend_code = act_rec.ret;
...
_end_label:;
   ...
   return act_rec.g389_aa_get_blend_code;
}


/* F181078_AA_GET_BLEND_STRI */

s_t_r f181078_aa_get_blend_stri(pad__16, blend_dist)
 integer pad__16;
 real blend_dist;
{
   ...
   struct ff181078_aa_get_blend_stri {
      ...
      s_t_r g390_aa_get_blend_string;
   } act_rec;
...
#ifdef COMP_TRACE
   if (act_rec._num_of_ && ncode_bit_fcn2(pad__16, blend_dist))
      return (s_t_r)ncode_lispob_answer;
#endif
...
_l2:;
   ...
   act_rec.g390_aa_get_blend_string = act_rec.blend_str;
...
_end_label:;
   ...
   return act_rec.g390_aa_get_blend_string;
}


/* F137706_AA_GET_SPEED_CODE */

integer f137706_aa_get_speed_code(pad__17, vel)
 integer pad__17;
 real vel;
{
   ...
   struct ff137706_aa_get_speed_code {
      ...
      integer ret;
      idob mm_6;   /* the global variable mm */
      padding_type pad__18;
      real tmp_2;
      integer integer_9;   /* 5 */
      boole tmp_5;
      lispob nil_11;   /* the global variable nil */
      integer integer_12;   /* 7500 */
      real tmp_1;
      integer integer_14;   /* 1 */
      integer integer_15;   /* 10 */
      real real_16;   /* 5.000000000000000e+000 */
      real step_size;
      integer integer_18;   /* 60 */
      padding_type pad__19;
      real real_20;   /* 1.000000000000000e+001 */
      integer integer_21;   /* 100 */
      padding_type pad__20;
      real real_23;   /* 2.000000000000000e+001 */
      integer integer_24;   /* 200 */
      padding_type pad__21;
      real real_26;   /* 5.000000000000000e+001 */
      integer integer_27;   /* 600 */
      padding_type pad__22;
      real real_29;   /* 1.000000000000000e+002 */
      integer integer_30;   /* 1000 */
      padding_type pad__23;
      real real_32;   /* 2.000000000000000e+002 */
      integer integer_33;   /* 3000 */
      padding_type pad__24;
      real real_35;   /* 5.000000000000000e+002 */
      real real_36;   /* 1.000000000000000e+003 */
      integer tmp_6;
      integer integer_38;   /* 0 */
      integer tmp_7;
      integer g391_aa_get_speed_code;
   } act_rec;
...
#ifdef COMP_TRACE
   if (act_rec._num_of_ && ncode_bit_fcn2(pad__17, vel))
      return ncode_integer_answer;
#endif
...
_l2:;
   ...
   act_rec.g391_aa_get_speed_code = act_rec.ret;
...
_end_label:;
   ...
   return act_rec.g391_aa_get_speed_code;
}


/* F371110_AA_GET_SPEED_STRI */

s_t_r f371110_aa_get_speed_stri(pad__25, vel)
 integer pad__25;
 real vel;
{
   ...
   struct ff371110_aa_get_speed_stri {
      ...
      s_t_r g392_aa_get_speed_string;
   } act_rec;
...
#ifdef COMP_TRACE
   if (act_rec._num_of_ && ncode_bit_fcn2(pad__25, vel))
      return (s_t_r)ncode_lispob_answer;
#endif
...
_l2:;
   ...
   act_rec.g392_aa_get_speed_string = act_rec.speed_str;
...
_end_label:;
   ...
   return act_rec.g392_aa_get_speed_string;
}
...
_l1:;
   ...
   act_rec.g394 = act_rec.motion_id;
   act_rec.tmp_0 = eq(
      act_rec.g394,
      act_rec.id_20
   );
...
_l8:;
   ...
   act_rec.g393_aa_build_move_cmd = act_rec.full_cmd;
...
_end_label:;
   ...
   return act_rec.g393_aa_build_move_cmd;
}


/* F45332_AA_BUILD_MOVE_CMD */

s_t_r f45332_aa_build_move_cmd(proc_num, pnt_num, motion_id, trigger_str, tool_name, offset_var, pad__26, spd, bld)
 integer proc_num;
 integer pnt_num;
 id motion_id;
 s_t_r trigger_str;
 ...
 real bld;
{
...
#ifdef COMP_TRACE
   if (act_rec._num_of_ && ncode_bit_fcn2(proc_num, pnt_num, motion_id, trigger_str, tool_name, offset_var, pad__26, spd, bld))
      return (s_t_r)ncode_lispob_answer;
#endif
   ...
   act_rec.g395_aa_build_move_cmd = f973220_aa_build_move_cmd(
      proc_num,
      pnt_num,
      act_rec.motion_id,
      act_rec.trigger_str,
...
_end_label:;
   ...
   return act_rec.g395_aa_build_move_cmd;
}
 ...
 real bld;
{
   ...
   act_rec.proc_num =    -(1);
   act_rec.g396_aa_build_move_cmd = f45332_aa_build_move_cmd(
      act_rec.proc_num,
      pnt_num,
      act_rec.motion_id,
      act_rec.trigger_str,
...
_end_label:;
   ...
   return act_rec.g396_aa_build_move_cmd;
}
 ...
 s_t_r offset_var;
{
   ...
   struct ff157062_aa_build_move_cmd {
      ...
      id id_10;   /* CSL */
      boole tmp_0;
      padding_type pad__27;
      real spd;
      idob false_14;   /* the global variable false */
      boole use_jointtarget;
      id id_16;   /* JSI */
      idob aa_joint_speed_factor_17;   /* the global variable aa_joint_speed_factor */
      idob aa_allow_jointtargets_18;   /* the global variable aa_allow_jointtargets */
      shapep via_shp;
      boole tmp_2;
      nobj tmp_8;
      type_type type_type_22;   /* the type jv_shape */
      jv_shapep tmp_7;
      nobj tmp_1;
      lispob nil_25;   /* the global variable nil */
      idob aa_max_blend_dist_26;   /* the global variable aa_max_blend_dist */
      padding_type pad__28;
      real bld;
      s_t_r g397_aa_build_move_cmd;
   } act_rec;
   ...
   act_rec.g398 = act_rec.mr->motion_kind;
   act_rec.tmp_0 = eq(
      act_rec.g398,
      act_rec.id_10
   );
   ...
   act_rec.use_jointtarget = ((boole)(act_rec.false_14->id_value));
   goto _l2;
...
_l1:;
   ...
   if (!((boole)(act_rec.tmp_0))) goto _l2;
   act_rec.spd = act_rec.mr->joint_velocity.value * (*((real *)(((charp)(act_rec.aa_joint_speed_factor_17->id_value)) + sizeof(real))));
   if (!(((boole)(act_rec.aa_allow_jointtargets_18->id_value)))) goto _l2;
...
_l2:;
   ...
   act_rec.bld = act_rec.mr->blend.value * (*((real *)(((charp)(act_rec.aa_max_blend_dist_26->id_value)) + sizeof(real))));
   act_rec.g397_aa_build_move_cmd = f973220_aa_build_move_cmd(
      proc_num,
      pnt_num,
      act_rec.motion_id,
      act_rec.trigger_str,
...
_end_label:;
   ...
   return act_rec.g397_aa_build_move_cmd;
}
 ...
 s_t_r offset_var;
{
   ...
   act_rec.proc_num =    -(1);
   act_rec.g399_aa_build_move_cmd = f157062_aa_build_move_cmd(
      act_rec.mr,
      act_rec.proc_num,
      pnt_num,
      act_rec.trigger_str,
...
_end_label:;
   ...
   return act_rec.g399_aa_build_move_cmd;
}

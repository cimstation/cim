 ...
 aa_position_rec__sarray pos_arr;
{
   ...
   struct ff867830_aa_write_position {
      ...
      id id_18;   /* ROBOT */
      id frame_id;
      id g367__rite_positions_to_file;
   } act_rec;
   ...
   act_rec._s_818 = (osarrayp)act_rec.pos_arr;
   act_rec._s_816 = 0;
   act_rec._s_817 = act_rec._s_818->index;
   act_rec._s_819 = act_rec._s_818->goods;

_l1:;

   act_rec.tmp_0 = (boole)boolean2obj(act_rec._s_816 > act_rec._s_817);
   if (!((boole)(act_rec.tmp_0))) goto _l2;
   goto _l3;

_l2:;

   act_rec.tmp_0 = (boole)((lispobp)(ARRAY_BODY(act_rec._s_819)))[act_rec._s_816];
...
_l4:;
   ...
   act_rec.tmp_2 = (integer)act_rec._s_816 + 1;
   act_rec._s_816 = (integer)(act_rec.tmp_2);
   goto _l1;
...
_l3:;
   ...
   act_rec.g367__rite_positions_to_file = act_rec.frame_id;
...
_end_label:;
   ...
   return act_rec.g367__rite_positions_to_file;
}
 ...
 xobp xo;
{
   ...
   struct ff195733_aa_get_xob_with_p {
      ...
      universal tmp_9;
      aa_xob_with_progdatap g368_a_get_xob_with_progdata;
   } act_rec;
...
_l1:;
   ...
   act_rec.g368_a_get_xob_with_progdata = act_rec.xp;
...
_end_label:;
   ...
   return act_rec.g368_a_get_xob_with_progdata;
}
 ...
 xobp xo;
{
   ...
   struct ff340434_aa_init_xob_progd {
      ...
      pathname tmp_2;
      lispob tmp_4;
      aa_xob_with_progdatap g369_aa_init_xob_progdata;
   } act_rec;
...
_l2:;
   ...
   act_rec.g369_aa_init_xob_progdata = act_rec.xp;
...
_end_label:;
   ...
   return act_rec.g369_aa_init_xob_progdata;
}
 ...
 xobp prog_xob;
{
   ...
   struct ff754847_aa_get_new_subpro {
      ...
      integer g370__get_new_subprog_number;
   } act_rec;
...
_l3:;
   ...
   act_rec._s_821 = act_rec.xp->subprog_list;
...
_l7:;
   ...
   act_rec._s_821 = (lispob)(act_rec.tmp_0);
   goto _l2;
...
_l4:;
   ...
   act_rec.g370__get_new_subprog_number = act_rec.next_num;
...
_end_label:;
   ...
   return act_rec.g370__get_new_subprog_number;
}
 ...
 pathname this_path;
{
   ...
   act_rec.g371_aa_add_subprog = act_rec.ret;
...
_end_label:;
   ...
   return act_rec.g371_aa_add_subprog;
}
 ...
 pathname this_path;
{
   ...
   struct ff887897_aa_remove_subprog {
      ...
      s_t_r tmp_6;
      integer g372_aa_remove_subprog;
   } act_rec;
   ...
   act_rec._s_824 = act_rec.xp->subprog_list;
...
_l6:;
   ...
   act_rec._s_824 = (lispob)(act_rec.tmp_2);
   goto _l1;
...
_l3:;
   ...
   act_rec.g372_aa_remove_subprog = act_rec.ret;
...
_end_label:;
   ...
   return act_rec.g372_aa_remove_subprog;
}
 ...
 xobp prog_xob;
{
   ...
   struct ff308726_aa_get_progdata_u {
      ...
      shapep g373__gt_progdata_user_frame;
   } act_rec;
...
_l1:;
   ...
   act_rec.g373__gt_progdata_user_frame = act_rec.ret;
...
_end_label:;
   ...
   return act_rec.g373__gt_progdata_user_frame;
}
